...
#endif
      _delay_ms(1);
      LCD_invoiSendCommand(0x0f); //dispaly on/off
      _delay_ms(1);
...
ES_t LCD_FloatingPoint(f32 Copy_f32Num)
{
	ES_t LocalErrorState =NOT_OK;
	   u32 intPart = (u32)Copy_f32Num;
	   f32 fracPart = (Copy_f32Num - intPart);
	   u32 n=fracPart*10000;
